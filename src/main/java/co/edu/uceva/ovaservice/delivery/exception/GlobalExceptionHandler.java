...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handlePaginaSinProductos(PaginaSinOvasException ex) {
    ...
    public ResponseEntity<Map<String, Object>> handleNoHayProductos(NoHayOvasException ex) {
        Map<String, Object> response = new HashMap<>();
    ...
    public ResponseEntity<Map<String, Object>> handleProductoNoEncontrado(OvaNoEncontradoException ex) {
        Map<String, Object> response = new HashMap<>();
    ...
    public ResponseEntity<Map<String, Object>> handleProductoExistente(OvaExistenteException ex) {
        Map<String, Object> response = new HashMap<>();
        response.put(ERROR, ex.getMessage());
